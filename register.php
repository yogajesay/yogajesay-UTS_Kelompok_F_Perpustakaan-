                ...
                <div class="card-body">
                    <form action="proses/registerProses.php" method="post">
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="nama" name="nama" placeholder="nama" aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                    ...
                    <p class="mt-2">Sudah punya akun? <a href="login.php" class="text-primary">Login Disini!</a></p>
                </div>
            </div>
