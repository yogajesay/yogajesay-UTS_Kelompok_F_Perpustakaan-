                ...
                if(mysqli_num_rows($query)==0){
                    ...
                    while($data = mysqli_fetch_assoc($query)){
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="editBukuAdmin.php?id='.$data['id'].'"><i style="color: green" class="fa fa-edit"></i></a>
                            
                            <a href="deleteBukuAdminProses.php?id='.$data['id'].'" onClick="return confirm(\'Yakin?\')"><i style="color:red" class="fa fa-trash"></i>
                            </a>
                            </td>
                        </tr>';
                    $no++;
